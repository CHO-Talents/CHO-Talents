-- TASK-104: QR 달란트의 수령 발생 시각과 지급 대상일 분리
-- 실행 위치: Supabase Dashboard > SQL Editor
-- 선행 작업: TASK-099_scheduled_talent_grant_dates.sql
--
-- created_at 및 talent_qr_scans.scanned_at은 실제 QR 수령 발생 시각으로 유지하고,
-- grant_date에는 수령 발생일이 속한 주의 일요일(일요일 수령 시 당일)을 기록합니다.
