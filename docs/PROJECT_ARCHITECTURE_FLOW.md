...
작성 기준: 2026-06-02 KST 현재 코드 기준 (v3.23.0)
...
| `admin/talent-stats.html` | 60등급 이상 달란트 누적적립 통계. 전체: 거래 수→항목+개 접미사, 총 달란트→달란트. 부서별: 모바일 1인평균/그래프 숨김, pct-bar 표시, 상세 모달. 사용자별: 교사/학생 그룹+페이징(10/20), 상세 모달. 라디오 필터, 부서 필터, 기간 프리셋 |
