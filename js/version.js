  ...
  history: [
    {
      version: '4.0.0',
      date: '2026-08-07',
      title: '달란트 지급 복구 및 사용자 통계 정렬 개선',
      changes: [
        '달란트 지급 요청의 응답이 끊긴 경우, 서버의 최근 지급 내역을 확인해 이미 완료된 지급을 안전하게 복구합니다.',
        '작업 로그와 Slack 알림에서 네트워크·Edge Function 오류 및 주요 데이터 항목의 영문 메시지를 한국어로 표시합니다.',
        '사용자 로그인 통계 표는 최신 날짜와 로그인 횟수 기준으로 정렬하고, 차트는 날짜·요일·시간·부서의 자연스러운 순서를 유지합니다.'
      ]
    },
    {
      version: '3.99.0',
