...
const CODE_ITEMS = {
  ...
  'activity_logs.action': [
    ...
    { key: 'USER_ID_CHECK_FAIL', value: '아이디 중복 확인 실패', category: 'USER', emoji: '🔎', order: 1060 },
    { key: 'USER_ID_CHECK_DUPLICATE', value: '아이디 중복', category: 'USER', emoji: '🔎', order: 1070 },
    ...
    { key: 'BULK_REGISTER', value: '학생 일괄 등록', category: 'REGISTER', emoji: '📥', order: 2040 },
    ...
    { key: 'LOGIN_FAIL', value: '로그인 실패', category: 'AUTH', emoji: '🔒', order: 7011 },
    { key: 'LOGIN_ERROR', value: '로그인 오류', category: 'AUTH', emoji: '⚠️', order: 7012 },
    { key: 'AUTH_SESSION_MISSING', value: '인증 세션 없음', category: 'AUTH', emoji: '⏱️', order: 7013 },
    { key: 'AUTH_PROFILE_LOAD_FAIL', value: '인증 프로필 조회 실패', category: 'AUTH', emoji: '⚠️', order: 7014 },
    { key: 'AUTH_REDIRECT', value: '인증/권한 리디렉트', category: 'AUTH', emoji: '↪️', order: 7015 },
    { key: 'AUTH_PAGE_ACCESS_CHECK_FAIL', value: '페이지 접근 권한 확인 실패', category: 'AUTH', emoji: '🛡️', order: 7016 },
    { key: 'QR_LOCATION_PERMISSION_BLOCKED', value: 'QR 위치 권한 차단', category: 'AUTH', emoji: '📍', order: 7017 },
    { key: 'APP_VERSION_STALE_SESSION', value: '구버전 세션 감지', category: 'AUTH', emoji: '🔄', order: 7018 },
    ...
    { key: 'ANNOUNCEMENT_READ_STATUS_VIEW', value: '공지 열람 현황 조회', category: 'PERM', emoji: '👁️', order: 9085 },
